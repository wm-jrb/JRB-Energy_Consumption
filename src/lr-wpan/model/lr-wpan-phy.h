...
typedef struct {
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	double jrb;		  //!< Number of symbols for the JRB
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
public:
	 ...
	 */
	static void EnableJRB(void);

	/**
	 * Disables the physical jamming resistance
	 */
	static void DisableJRB(void);

	/**
	 * Checks, if jrb is enabled.
	 */
	static bool IsJrbEnabled(void);

	/**
	 * Determines the position of the JRB.
	 * @param earlyJRB: true, if JRB before PHR
	 */
	static void SetEarlyJRB(bool earlyJRB);

	/**
	 * Returns, if JRB is before PHR
	 */
	static bool IsEarlyJRB(void);
	...
	/**
	 * Outputs the Header on the given stream
	 */
	...
	typedef void (*StateTracedCallback)(Time time,
			LrWpanPhyEnumeration oldState, LrWpanPhyEnumeration newState);
	 ...
	 */
	typedef void (*RxEndTracedCallback)(const Ptr<const Packet> packet,
			const double sinr);
...
private:
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	/**
	 * Shows if jrb is enabled.
	 */
	static bool jrb_enabled;

	static bool early_jrb;
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
