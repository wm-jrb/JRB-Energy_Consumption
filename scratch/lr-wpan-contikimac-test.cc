...
//
//  Ptr<Packet> p1 = Create<Packet> (55);  // 50 bytes of dummy data
//  params.m_dstAddr = Mac16Address ("00:03");
//  Simulator::Schedule (Seconds (0.5), &LrWpanMac::McpsDataRequest, dev0->GetMac (), params, p1);       //phy1 drop pkt to phy3
//
//  Ptr<Packet> p2 = Create<Packet> (60);  // 50 bytes of dummy data
...
//
//  Ptr<Packet> p3 = Create<Packet> (70);  // 50 bytes of dummy data
//  params.m_txOptions = TX_OPTION_NONE;
//  Simulator::Schedule (Seconds (1.52), &LrWpanMac::McpsDataRequest, dev2->GetMac (), params, p3);

  Ptr<Packet> p1 = Create<Packet> (60);  // 50 bytes of dummy data
  Simulator::Schedule (Seconds (0.1), &LrWpanMac::McpsDataRequest, dev0->GetMac (), params, p0);
  Simulator::Schedule (Seconds (0.5), &LrWpanMac::McpsDataRequest, dev2->GetMac (), params, p1);
