...
typedef struct {
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	double pjr;		  //!< Number of symbols for the PJR //Tobi
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
public:
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	/**
	 * This section describes the main part of the implementation that is necessary to indroduce a PJR
	 * @author Tobi
	 */
	 ...
	 */
	static void EnablePJR(void);

	/**
	 * Disables the physical jamming resistance
	 */
	static void DisablePJR(void);

	static bool IsPjrEnabled(void);

	static void SetEarlyPJR(bool earlyPJR);

	static bool IsEarlyPJR(void);
...
private:
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	/**
	 * Shows if pjr is enabled. //Tobi
	 */
	static bool pjr_enabled;

	static bool early_pjr;
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
